...
const styles = {
  card: { background: '#16213e', borderRadius: '12px', overflow: 'hidden', width: '320px', color: '#fff', boxShadow: '0 4px 20px rgba(0,0,0,0.4)' },
  photo: { width: '100%', height: '220px', objectFit: 'cover' },
  info: { padding: '16px' },
  ...
  btn: { flex: 1, padding: '10px', border: 'none', borderRadius: '6px', color: '#fff', cursor: 'pointer', fontWeight: 'bold' },
};
